...
<!-- bootstrap -->
<link href="/web/resources/css/bootstrap.min.css" rel='stylesheet' type='text/css' media="all" />
<!-- //bootstrap -->
<link href="/web/resources/css/dashboard.css" rel="stylesheet">
<!-- Custom Theme files -->
<link href="/web/resources/css/style.css" rel='stylesheet' type='text/css' media="all" />
	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="home"><h1>
					<img src="/web/resources/images/logo.png" alt="" style="max-height: 60px;margin-top: -5px;" />	
				</h1></a>
		</div>
		<div id="navbar" class="navbar-collapse collapse">
			...
			<div class="header-top-right">
				...
				<div class="file">
					<img src="/web/resources/images/profile.png" alt="perfil">
				</div>
				<div class="file">
				<p id="usuarioLogueado"><%= request.getSession().getAttribute("usuarioLogueado") %></p>
				</div>
				<div class="signin">
